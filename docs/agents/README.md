...
Start with root `AGENTS.md`. Read these files only when relevant.

## Core Docs

- `README.md` - this index and routing table
- `repo-map.md` - canonical Chimera repo map, source labels, and local-adjacent checkout notes
- `commands.md` - discovery, audit, and docs-only validation commands
...
| Task | Read |
|---|---|
| Understanding what Chimera repos exist | `repo-map.md` |
